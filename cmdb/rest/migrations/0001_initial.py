    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tree_id', models.PositiveIntegerField(db_index=True, editable=False)),
                ('level', models.PositiveIntegerField(db_index=True, editable=False)),
                ('leaders', models.ManyToManyField(related_name='leader_ships', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dbs', models.ManyToManyField(to='rest.Db')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.AddField(
            ...
            name='parent',
            field=mptt.fields.TreeForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='children', to='rest.BaseService'),
        ),
        migrations.AddField(
            model_name='baseresource',
            name='departments',
            field=models.ManyToManyField(to='rest.Department'),
        ),
        migrations.AddField(
            model_name='baseresource',
        ...
        migrations.AddField(
            ...
            name='resources',
            field=models.ManyToManyField(blank=True, to='rest.BaseResource'),
        ),
